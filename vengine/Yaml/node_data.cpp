...
#include <Yaml/yaml-cpp/node/detail/memory.h>
#include <Yaml/yaml-cpp/node/detail/node.h>// IWYU pragma: keep
#include <Yaml/yaml-cpp/node/detail/node_data.h>
#include <Yaml/yaml-cpp/node/detail/node_iterator.h>
...
void node_data::set_scalar(const vstd::string_view& scalar) {
	m_isDefined = true;
	m_type = NodeType::Scalar;
	m_scalar = std::string(scalar.begin(), scalar.end());
}
