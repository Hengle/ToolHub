...
BuddyAllocator::BuddyAllocator(uint binaryLayer, uint treeCapacity, uint64_t initSize, Runnable<void*(uint64_t)>&& blockConstructor, Runnable<void(void*)>&& resourceBlockDestructor)
