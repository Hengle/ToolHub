...
namespace MPipeline
{
    ...
    public unsafe static class MUnsafeUtility
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativeArray<T> GetNativeArray<T>(T* ptr, int len) where T : unmanaged
        {
            NativeArray<T> arr = NativeArrayUnsafeUtility.ConvertExistingDataToNativeArray<T>(ptr, len, Allocator.None);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void* VoidPtr<T>(ref this T array) where T : struct
        {
            return AddressOf(ref array);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void* VoidPtr<T>(ref this NativeArray<T> array) where T : struct
        {
            return array.GetUnsafePtr();
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void* VoidPtr<T>(ref this MPipeline.NativeList<T> array) where T : unmanaged
        {
            return array.unsafePtr;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T* Malloc<T>(long byteSize, Allocator allocator) where T : unmanaged
        {
            return (T*)UnsafeUtility.Malloc(byteSize, 16, allocator);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
